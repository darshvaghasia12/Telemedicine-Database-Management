...
import { runOutsideAngular, ɵlazySDKProxy, FIREBASE_OPTIONS, FIREBASE_APP_NAME, _firebaseAppFactory } from '@angular/fire';
;
...
var AngularFireAnalytics = (function () {
    function AngularFireAnalytics(options, nameOrConfig, analyticsCollectionEnabled, providedAppVersion, providedAppName, debugModeEnabled, providedConfig, platformId, zone) {
        ...
        var analytics = of(undefined).pipe(switchMap(function () { return zone.runOutsideAngular(function () { return import('firebase/analytics'); }); }), map(function () { return _firebaseAppFactory(options, zone, nameOrConfig); }), map(function (app) { return app.analytics(); }), tap(function (analytics) {
            if (analyticsCollectionEnabled === false) {
                analytics.setAnalyticsCollectionEnabled(false);
            }
        }), runOutsideAngular(zone), shareReplay({ bufferSize: 1, refCount: false }));
